...
export const workProjects: WorkProject[] = [
  {
    ...
    caseStudy: {
      ...
      results:
        '交付 <strong>投放管理+数据管理+风控一体化投放平台</strong>，年均管理超 <strong>5000 万美元</strong>广告预算，覆盖 <strong>1000+</strong> 广告账户，支撑 10+ 人投放团队日常运作。形成从投放管理、数据策略到风控结算的完整闭环，<strong>AI 建议与一键应用</strong>缩短「看数—判断—改价」路径。基于平台数据与策略沉淀，完成<strong>智能投放 Agent 方案设计</strong>，为 AI 驱动投放演进提供储备。与波波等前序数据/投放类产品形成同一产品线上的能力递进。',
    },
  },
  {
